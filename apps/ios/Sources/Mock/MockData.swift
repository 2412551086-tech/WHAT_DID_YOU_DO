...
enum MockData {
    ...
    static let coreChores: [ChoreItem] = [
        ChoreItem(id: "mock-chore-cook", name: "做饭 / 备餐", category: "厨房类", minutes: 45, points: 68, icon: "flame.fill", color: DSColor.coral),
        ChoreItem(id: "mock-chore-dishes", name: "饭后收拾 / 洗碗", category: "厨房类", minutes: 15, points: 21, icon: "fork.knife", color: DSColor.yellow),
        ChoreItem(id: "mock-chore-laundry", name: "洗衣服", category: "洗护类", minutes: 10, points: 13, icon: "washer.fill", color: DSColor.clay),
        ChoreItem(id: "mock-chore-put-away-clothes", name: "收衣 / 叠衣", category: "洗护类", minutes: 15, points: 18, icon: "square.stack.3d.up.fill", color: DSColor.mint),
        ...
        ChoreItem(id: "mock-chore-bathroom", name: "卫生间清洁", category: "清洁类", minutes: 20, points: 30, icon: "shower.fill", color: DSColor.lavender),
        ChoreItem(id: "mock-chore-trash", name: "倒垃圾 / 垃圾分类", category: "清洁类", minutes: 10, points: 10, icon: "trash.fill", color: DSColor.sky),
        ChoreItem(id: "mock-chore-shopping", name: "采购补货 / 家庭物资管理", category: "采购类", minutes: 30, points: 36, icon: "cart.fill", color: DSColor.coral),
    ]
